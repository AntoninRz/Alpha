    ...
    <div className='container mx-auto w-full flex items-center justify-arround py-8'>
        <div className='w-11/12 md:w-3/4 flex flex-col justify-center items-center gap-6 mx-auto'>
            ...
            <div className='relative rounded-3xl border border-zinc-400 w-full h-60'>
                ...
                <div className='w-fit flex flex-col md:flex-row z-10 items-center md:items-start justify-center md:justify-start gap-4 lg:gap-8 absolute bottom-4 left-1/2 transform -translate-x-1/2 lg:translate-x-0 lg:left-4 backdrop-blur-sm  border-t border-b border-white py-2 lg:border-0'>
            ...
            <div className='relative rounded-3xl border border-zinc-400 w-full h-60'>
                ...
                <div className='w-fit flex flex-col md:flex-row z-20 items-center md:items-start justify-center md:justify-end gap-4 lg:gap-8 absolute bottom-4 right-1/2 transform translate-x-1/2 lg:translate-x-0 lg:right-4 backdrop-blur-sm  border-t border-b border-white py-2 lg:border-0'>
